...
namespace PgSAIndex {
    ...
    PseudoGenomeBase* AbstractOverlapPseudoGenomeGeneratorTemplate<uint_read_len, uint_reads_cnt>::assemblePseudoGenomeFullTemplate() {
        ...
        genPG->buildReadsWithDuplicatesFilter();
...
//        genPG->setCountQueriesCache(new GeneratedCountQueriesCache(genPG, genPG->getReadsSetProperties()));
    ...
    template<typename uint_read_len, typename uint_reads_cnt>
    bool AbstractOverlapPseudoGenomeGeneratorTemplate<uint_read_len, uint_reads_cnt>::isHeadOf(uint_reads_cnt head, uint_reads_cnt idx) {
