...
namespace PgSAIndex {
    ...
    inline bool isSALengthStd(uint_max saLength) { return saLength <= UINT_MAX - 2 ; }
    inline bool isSALengthMax(uint_max saLength) { return !isSALengthStd(saLength) && (saLength <= ULLONG_MAX - 2); }

    inline bool isSABytesStd(uint_max pgLength, int bytesPerElement) { return isSALengthStd(pgLength * bytesPerElement); }
    inline bool isSABytesMax(uint_max pgLength, int bytesPerElement) { return isSALengthMax(pgLength * bytesPerElement); }
