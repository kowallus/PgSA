...
${OBJECTDIR}/src/helper.o: src/helper.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/helper.o src/helper.cpp

${OBJECTDIR}/src/pgsaconfig.o: src/pgsaconfig.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pgsaconfig.o src/pgsaconfig.cpp
...
${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.o: src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.cpp
...
${TESTDIR}/src/tests/PgSAgen-fasta-human.o: src/tests/PgSAgen-fasta-human.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/PgSAgen-fasta-human.o src/tests/PgSAgen-fasta-human.cpp


${TESTDIR}/src/tests/gkbugdump.o: src/tests/gkbugdump.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/gkbugdump.o src/tests/gkbugdump.cpp
...
${OBJECTDIR}/src/helper_nomain.o: ${OBJECTDIR}/src/helper.o src/helper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -s -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/helper_nomain.o src/helper.cpp;\
	else  \
...
${OBJECTDIR}/src/pgsaconfig_nomain.o: ${OBJECTDIR}/src/pgsaconfig.o src/pgsaconfig.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -s -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pgsaconfig_nomain.o src/pgsaconfig.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator_nomain.o: ${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -s -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator_nomain.o src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.cpp;\
	else  \
