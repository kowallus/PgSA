...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libPgSA.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libPgSA.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -s -fPIC

${OBJECTDIR}/src/helper.o: src/helper.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/helper.o src/helper.cpp

${OBJECTDIR}/src/index/PgSAIndexFactory.o: src/index/PgSAIndexFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/index
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/index/PgSAIndexFactory.o src/index/PgSAIndexFactory.cpp

${OBJECTDIR}/src/index/cache/persistence/CountQueriesCachePersistence.o: src/index/cache/persistence/CountQueriesCachePersistence.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/index/cache/persistence
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/index/cache/persistence/CountQueriesCachePersistence.o src/index/cache/persistence/CountQueriesCachePersistence.cpp

${OBJECTDIR}/src/pgsaconfig.o: src/pgsaconfig.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pgsaconfig.o src/pgsaconfig.cpp

${OBJECTDIR}/src/pseudogenome/DefaultPseudoGenome.o: src/pseudogenome/DefaultPseudoGenome.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/DefaultPseudoGenome.o src/pseudogenome/DefaultPseudoGenome.cpp

${OBJECTDIR}/src/pseudogenome/PackedPseudoGenome.o: src/pseudogenome/PackedPseudoGenome.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/PackedPseudoGenome.o src/pseudogenome/PackedPseudoGenome.cpp

${OBJECTDIR}/src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator.o: src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome/generator
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator.cpp

${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator.o: src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome/generator
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator.cpp

${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator.o: src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome/generator
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator.cpp
...
${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.o: src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome/generator
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.cpp

${OBJECTDIR}/src/pseudogenome/packing/SymbolsPackingFacility.o: src/pseudogenome/packing/SymbolsPackingFacility.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome/packing
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/packing/SymbolsPackingFacility.o src/pseudogenome/packing/SymbolsPackingFacility.cpp

${OBJECTDIR}/src/pseudogenome/persistence/PseudoGenomePersistence.o: src/pseudogenome/persistence/PseudoGenomePersistence.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome/persistence
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/persistence/PseudoGenomePersistence.o src/pseudogenome/persistence/PseudoGenomePersistence.cpp

${OBJECTDIR}/src/pseudogenome/readslist/ListOfConstantLengthReads.o: src/pseudogenome/readslist/ListOfConstantLengthReads.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pseudogenome/readslist
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/readslist/ListOfConstantLengthReads.o src/pseudogenome/readslist/ListOfConstantLengthReads.cpp

${OBJECTDIR}/src/readsset/DefaultReadsSet.o: src/readsset/DefaultReadsSet.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/readsset
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/readsset/DefaultReadsSet.o src/readsset/DefaultReadsSet.cpp

${OBJECTDIR}/src/readsset/PackedReadsSet.o: src/readsset/PackedReadsSet.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/readsset
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/readsset/PackedReadsSet.o src/readsset/PackedReadsSet.cpp

${OBJECTDIR}/src/readsset/iterator/ReadsSetIterator.o: src/readsset/iterator/ReadsSetIterator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/readsset/iterator
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/readsset/iterator/ReadsSetIterator.o src/readsset/iterator/ReadsSetIterator.cpp

${OBJECTDIR}/src/sais/sais.o: src/sais/sais.c 
	${MKDIR} -p ${OBJECTDIR}/src/sais
	${RM} "$@.d"
	$(COMPILE.c) -I. -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sais/sais.o src/sais/sais.c

${OBJECTDIR}/src/suffixarray/DefaultSuffixArray.o: src/suffixarray/DefaultSuffixArray.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/suffixarray
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/suffixarray/DefaultSuffixArray.o src/suffixarray/DefaultSuffixArray.cpp

${OBJECTDIR}/src/suffixarray/SparseSuffixArray.o: src/suffixarray/SparseSuffixArray.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/suffixarray
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/suffixarray/SparseSuffixArray.o src/suffixarray/SparseSuffixArray.cpp

${OBJECTDIR}/src/suffixarray/persistence/SuffixArrayPersistence.o: src/suffixarray/persistence/SuffixArrayPersistence.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/suffixarray/persistence
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/suffixarray/persistence/SuffixArrayPersistence.o src/suffixarray/persistence/SuffixArrayPersistence.cpp

${OBJECTDIR}/src/test/PgSAtests.o: src/test/PgSAtests.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/test
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/test/PgSAtests.o src/test/PgSAtests.cpp

${OBJECTDIR}/src/test/testdata.o: src/test/testdata.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/test
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/test/testdata.o src/test/testdata.cpp
...
${OBJECTDIR}/src/helper_nomain.o: ${OBJECTDIR}/src/helper.o src/helper.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/helper_nomain.o src/helper.cpp;\
	else  \
...
${OBJECTDIR}/src/index/PgSAIndexFactory_nomain.o: ${OBJECTDIR}/src/index/PgSAIndexFactory.o src/index/PgSAIndexFactory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/index/PgSAIndexFactory_nomain.o src/index/PgSAIndexFactory.cpp;\
	else  \
...
${OBJECTDIR}/src/index/cache/persistence/CountQueriesCachePersistence_nomain.o: ${OBJECTDIR}/src/index/cache/persistence/CountQueriesCachePersistence.o src/index/cache/persistence/CountQueriesCachePersistence.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/index/cache/persistence/CountQueriesCachePersistence_nomain.o src/index/cache/persistence/CountQueriesCachePersistence.cpp;\
	else  \
...
${OBJECTDIR}/src/pgsaconfig_nomain.o: ${OBJECTDIR}/src/pgsaconfig.o src/pgsaconfig.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pgsaconfig_nomain.o src/pgsaconfig.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/DefaultPseudoGenome_nomain.o: ${OBJECTDIR}/src/pseudogenome/DefaultPseudoGenome.o src/pseudogenome/DefaultPseudoGenome.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/DefaultPseudoGenome_nomain.o src/pseudogenome/DefaultPseudoGenome.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/PackedPseudoGenome_nomain.o: ${OBJECTDIR}/src/pseudogenome/PackedPseudoGenome.o src/pseudogenome/PackedPseudoGenome.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/PackedPseudoGenome_nomain.o src/pseudogenome/PackedPseudoGenome.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator_nomain.o: ${OBJECTDIR}/src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator_nomain.o src/pseudogenome/generator/AbstractOverlapPseudoGenomeGenerator.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator_nomain.o: ${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator_nomain.o src/pseudogenome/generator/GreedySwipingDefaultOverlapPseudoGenomeGenerator.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator_nomain.o: ${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator_nomain.o src/pseudogenome/generator/GreedySwipingPackedOverlapPseudoGenomeGenerator.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator_nomain.o: ${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.o src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator_nomain.o src/pseudogenome/generator/GreedyVerticalOverlapPseudoGenomeGenerator.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/packing/SymbolsPackingFacility_nomain.o: ${OBJECTDIR}/src/pseudogenome/packing/SymbolsPackingFacility.o src/pseudogenome/packing/SymbolsPackingFacility.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/packing/SymbolsPackingFacility_nomain.o src/pseudogenome/packing/SymbolsPackingFacility.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/persistence/PseudoGenomePersistence_nomain.o: ${OBJECTDIR}/src/pseudogenome/persistence/PseudoGenomePersistence.o src/pseudogenome/persistence/PseudoGenomePersistence.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/persistence/PseudoGenomePersistence_nomain.o src/pseudogenome/persistence/PseudoGenomePersistence.cpp;\
	else  \
...
${OBJECTDIR}/src/pseudogenome/readslist/ListOfConstantLengthReads_nomain.o: ${OBJECTDIR}/src/pseudogenome/readslist/ListOfConstantLengthReads.o src/pseudogenome/readslist/ListOfConstantLengthReads.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pseudogenome/readslist/ListOfConstantLengthReads_nomain.o src/pseudogenome/readslist/ListOfConstantLengthReads.cpp;\
	else  \
...
${OBJECTDIR}/src/readsset/DefaultReadsSet_nomain.o: ${OBJECTDIR}/src/readsset/DefaultReadsSet.o src/readsset/DefaultReadsSet.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/readsset/DefaultReadsSet_nomain.o src/readsset/DefaultReadsSet.cpp;\
	else  \
...
${OBJECTDIR}/src/readsset/PackedReadsSet_nomain.o: ${OBJECTDIR}/src/readsset/PackedReadsSet.o src/readsset/PackedReadsSet.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/readsset/PackedReadsSet_nomain.o src/readsset/PackedReadsSet.cpp;\
	else  \
...
${OBJECTDIR}/src/readsset/iterator/ReadsSetIterator_nomain.o: ${OBJECTDIR}/src/readsset/iterator/ReadsSetIterator.o src/readsset/iterator/ReadsSetIterator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/readsset/iterator/ReadsSetIterator_nomain.o src/readsset/iterator/ReadsSetIterator.cpp;\
	else  \
...
${OBJECTDIR}/src/sais/sais_nomain.o: ${OBJECTDIR}/src/sais/sais.o src/sais/sais.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -I. -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sais/sais_nomain.o src/sais/sais.c;\
	else  \
...
${OBJECTDIR}/src/suffixarray/DefaultSuffixArray_nomain.o: ${OBJECTDIR}/src/suffixarray/DefaultSuffixArray.o src/suffixarray/DefaultSuffixArray.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/suffixarray/DefaultSuffixArray_nomain.o src/suffixarray/DefaultSuffixArray.cpp;\
	else  \
...
${OBJECTDIR}/src/suffixarray/SparseSuffixArray_nomain.o: ${OBJECTDIR}/src/suffixarray/SparseSuffixArray.o src/suffixarray/SparseSuffixArray.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/suffixarray/SparseSuffixArray_nomain.o src/suffixarray/SparseSuffixArray.cpp;\
	else  \
...
${OBJECTDIR}/src/suffixarray/persistence/SuffixArrayPersistence_nomain.o: ${OBJECTDIR}/src/suffixarray/persistence/SuffixArrayPersistence.o src/suffixarray/persistence/SuffixArrayPersistence.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/suffixarray/persistence/SuffixArrayPersistence_nomain.o src/suffixarray/persistence/SuffixArrayPersistence.cpp;\
	else  \
...
${OBJECTDIR}/src/test/PgSAtests_nomain.o: ${OBJECTDIR}/src/test/PgSAtests.o src/test/PgSAtests.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/test/PgSAtests_nomain.o src/test/PgSAtests.cpp;\
	else  \
...
${OBJECTDIR}/src/test/testdata_nomain.o: ${OBJECTDIR}/src/test/testdata.o src/test/testdata.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -I. -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/test/testdata_nomain.o src/test/testdata.cpp;\
	else  \
