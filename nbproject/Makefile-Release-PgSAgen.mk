...
${OBJECTDIR}/src/PgSAgen.o: nbproject/Makefile-${CND_CONF}.mk src/PgSAgen.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -Wall -s -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PgSAgen.o src/PgSAgen.cpp
...
${OBJECTDIR}/src/PgSAgen_nomain.o: ${OBJECTDIR}/src/PgSAgen.o src/PgSAgen.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -Wall -s -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PgSAgen_nomain.o src/PgSAgen.cpp;\
	else  \
